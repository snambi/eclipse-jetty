...
/**
 * Abstract implementation of the {@link IContainerLibStrategy} for external containers. 
 * Assumes that the libraries are in the lib folder
 * 
 * @author Manfred Hantschel
 */
public abstract class FileBasedContainerLibStrategy extends DependencyBasedContainerLibStrategy
{
